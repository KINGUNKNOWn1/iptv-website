    ...
    <section id="about" className="py-20 bg-brand-black">
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {values.map((value, index) => (
            <motion.div
              ...
              className="bg-white border border-brand-gray-border rounded-xl p-6 hover:border-brand-orange transition-all group"
            >
              {/* Icon */}
              <div className="w-14 h-14 rounded-xl bg-brand-orange flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
        ...
        >
          ...
          <Link
            to="/prijzen"
            className="inline-flex items-center gap-2 px-8 py-4 bg-brand-orange text-white font-bold rounded-xl hover:bg-[#E85D00] transition-all shadow-lg shadow-brand-orange/30"
          >
